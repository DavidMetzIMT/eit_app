...
class SciospecSetup(object):
    ...
    def get_freq_config(self, for_ser: bool = False) -> List[bytes]:
        ...
        data.extend(
            convertInt2Bytes(self.freq_config.freq_steps, 2)
    ...
    def get_exc_stamp(self, for_ser: bool = False) -> Union[List[bytes], bool]:
        ...
        return (
            [int(self.output_config.exc_stamp)]
            if for_ser
            else self.output_config.exc_stamp
        )
    ...
    def get_current_stamp(self, for_ser: bool = False) -> Union[List[bytes], bool]:
        ...
        - in bool for simple get"""
        return (
            [int(self.output_config.current_stamp)]
            if for_ser
            else self.output_config.current_stamp
        )
    ...
    def get_time_stamp(self, for_ser: bool = False) -> Union[List[bytes], bool]:
        ...
        - in bool for simple get"""
        return (
            [int(self.output_config.time_stamp)]
            if for_ser
            else self.output_config.time_stamp
        )
    ...
    def get_mac(self, for_ser: bool = False) -> Union[List[bytes], str]:
        ...
        - in str for simple get"""
        return (
            self.ethernet_config.mac if for_ser else self.ethernet_config.mac_formated
        )
    ...
    def get_dhcp(self, for_ser: bool = False) -> Union[List[bytes], bool]:
        ...
        - in bool for simple get"""
        return (
            [int(self.ethernet_config.dhcp)] if for_ser else self.ethernet_config.dhcp
        )
    ...
    def set_exc_amp_d(self, value: Union[List[bytes], float], for_ser: bool = False):
        ...
        self.exc_amp = (
            convert4Bytes2Float(value[DATA_START_INDX:-1]) if for_ser else value
        )
    ...
    def set_freq_config(
        self, value: List[bytes] = None, for_ser: bool = False, **kwargs
    ):
    ...
    def set_exc_pattern(
        self, value: Union[List[bytes], List[List[int]]], for_ser: bool = False
    ):
    ...
    def set_exc_stamp(self, value: Union[List[bytes], bool], for_ser: bool = False):
        ...
        self.output_config.exc_stamp = (
            True  # bool(value[DATA_START_INDX:-1][0]) if for_ser else value
        )
    ...
    def set_current_stamp(self, value: Union[List[bytes], bool], for_ser: bool = False):
        ...
        - out of Bytes from the device (rx_frame)
        - from a bool for simple set"""
        self.output_config.current_stamp = (
            True  # bool(value[DATA_START_INDX:-1][0]) if for_ser else value
        )
...
class FrequencyConfig(object):
    ...
    def make_freqs_list(self):
        ...
        logger.debug(f"Frequency list{self.freqs}")
        return self.freqs
